...
class VGG16:
    ...
    def createModel(self):
        ...
        self.logits = layers.fc(net, self.dataset.num_classes, activation_fn=None,
            weights_regularizer=layers.l2_regularizer(), name='logits')
